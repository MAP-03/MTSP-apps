                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                SvgPicture.asset('assets/svg/ekhairat.svg',
                                    width: 100),
                                Text('E-Khairat',
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                SvgPicture.asset('assets/svg/berita.svg',
                                    width: 100),
                                Text('Berita Masjid',
                                    style: GoogleFonts.poppins(
                                        fontSize: 14,
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                SvgPicture.asset('assets/svg/infaq.svg',
                                    width: 100),
                                Text('Infaq',
                                    style: GoogleFonts.poppins(
                                        fontSize: 14,
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                SvgPicture.asset('assets/svg/azan.svg',
                                    width: 100),
                                Text('Waktu Azan',
                                    style: GoogleFonts.poppins(
                                        fontSize: 14,
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                SvgPicture.asset('assets/svg/kalendar.svg',
                                    width: 100),
                                Text('Kalendar',
                                    style: GoogleFonts.poppins(
                                        fontSize: 14,
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                SvgPicture.asset('assets/svg/aduan.svg',
                                    width: 100),
                                Text(
                                  'Aduan Dan Cadangan',
                                  style: GoogleFonts.poppins(
