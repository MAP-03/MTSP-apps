...
class UpdaetAhliUser extends StatefulWidget {
  final Ahli ahli;
  const UpdaetAhliUser({super.key, required this.ahli});

  @override
  State<UpdaetAhliUser> createState() => _UpdaetAhliUserState();
}

class _UpdaetAhliUserState extends State<UpdaetAhliUser> {
  ...
  void _updateAhli() async {
    if (_formKey.currentState!.validate()) {
      ...
      ekhairatService.updateAhliStatus(ahli.email, 'Pending');
      await ekhairatService.updateAhli(ahli);
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (context) => SemakAhli()),
          (route) => false);
    }
  }
