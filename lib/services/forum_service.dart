...
class ForumsService extends ChangeNotifier{
  ...
  Future<void> createForum(String title, String description, String email, String username, File? imageFile) async {
  ...
  Future<void> createComment(String forumId, String comment, String email, String username, File? imageFile) async {
